...
VALUES(
'admin', '1234', '관리자', 'test@test.com', '010-1234-5678', '서울시 송파구', '123-12');
...
alter table TESTMEMBER add(AREA VARCHAR2(32));
alter table TESTMEMBER add(INTEREST VARCHAR2(32));
alter table TESTMEMBER add(ROLE VARCHAR2(32));
alter table TESTMEMBER add(STATUS VARCHAR2(32));
COMMIT;
