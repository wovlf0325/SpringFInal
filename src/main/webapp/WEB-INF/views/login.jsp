...
$("#signup-box-link").click(function(){
  $(".id-login").fadeOut(100);
  $(".email-signup").delay(100).fadeIn(100);
  $("#login-box-link").removeClass("active");
  $("#signup-box-link").addClass("active");
});
$("#login-box-link").click(function(){
  $(".id-login").delay(100).fadeIn(100);;
...
<body>
 ...
 <%@ include file="form/header.jsp" %>
  ...
  <div class="login-box">
    ...
    <form class="id-login" action="loginRes.do" method="post">
      <div class="u-form-group">
        <input type="text" name="member_id" placeholder="아이디를 입력해주세요."/>
      </div>
      <div class="u-form-group">
        <input type="password" name="member_pw" placeholder="비밀번호를 입력해 주세요."/>
      </div>
      <div class="u-form-group">
