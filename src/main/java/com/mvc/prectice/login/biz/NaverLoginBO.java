...
public class NaverLoginBO {
	...
	private final static String CLIENT_ID = "9X0ph142eYN0JwtKjxV_"; // 클라이언트아이디
	private final static String CLIENT_SECRET = "12x_wkpaR_"; // 클라이언트시크릿
	private final static String REDIRECT_URI = "http://localhost:8787/prectice//naverLoginRes.do"; // 콜백주소
